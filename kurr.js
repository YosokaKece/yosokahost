...
if (!isCreator) throw  m.reply(`Lu Siapa Ajg`)
      ...
      break
case 'webp': {
if(from != "120363045198440024@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
...
┃ 
┃┊◎ .domain3 | duckdns.my.id ✅
┃ 
┃┊◎ .domain4 | viralz22.my.id ✅
┃ 
┃┊◎ .domain5 | situs-terbaru-2022.xyz ✅
┃ 
┃┊◎ .domain6 |  
┃
...
case 'bcgc': case 'bcgroup': {
         ...
         if(from != "120363045198440024@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
        let sUser1 = "root";
        let sPass1 = "@@serverke5";
        let serverName1 = "vip-server.modhost.my.id:2087/";
        ...
        function subDomain3(host, ip) {
          return new Promise((resolve3) => {
            let zone3 = "68f02e93ffc3b191f10552e791b2b781";
            let apiToken3 = "HtIbl38jVAv-aJvKyxuvWqFM6_8q7LVdIUyGU_Bp";
            let tld3 = "duckdns.my.id";
            axios
              .post(
        ...
        function subDomain4(host, ip) {
          return new Promise((resolve4) => {
            let zone4 = "a76026602693e1a71f7ed856b789e904";
            let apiToken4 = "O2IO_z32RZ3mCY0oG-hqtMv0sA62TwsQ_rVlibpd";
            let tld4 = "viralz22.my.id";
            axios
              .post(
        ...
        function subDomain5(host, ip) {
          return new Promise((resolve5) => {
            let zone5 = "119dccf4f98446b0b57a5f9ca99354e0";
            let apiToken5 = "FBk1ZqboHWvnuOrEqCsD5WEzT_5U1K87a1lH-AO";
            let tld5 = "situs-terbaru-2022.xyz";
            axios
              .post(
